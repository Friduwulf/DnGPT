...
export default function Midieval() {
    ...
    function getSkillSum()  {
        ...
        let charismaValue = Number(inputValue4)
    ...
    <div className='flex flex-col items-center justify-center pt-5 pb-5 bg-secondary'>
        ...
        <div className='bg-secondary w-6/12 pb-5'>
            ...
            <input id='Charisma' type="range" min="0" max="10" value={inputValue4} onChange={handleChange4} className="range bg-secondary range-primary" step="1" />
            <div className="w-full flex justify-between text-xs px-2 bg-secondary">
            <span>0</span> 
            <span>1</span>
            <span>2</span>
